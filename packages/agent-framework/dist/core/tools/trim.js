 ...
 */
export function pruneFailureLog(text, opts) {
...
function headTailChars(text, maxChars) {
    if (text.length <= maxChars)
        return { text, trimmed: false, omittedBytes: 0 };
...
export function trimFailureOutput(text) {
