...
export type LifecycleHook = {
    ...
    onRunEnd?(input: {
        ...
        aborted: boolean;
        workspaceId?: string;
        newMessages?: RunTranscriptMessage[];
    }): void | Promise<void>;
};
export declare function fireRunStart(hooks: LifecycleHook[], input: {
    sessionId: string;
    agent: string;
    text: string;
}): Promise<void>[];
/** 返回第一个生效的 block；钩子抛错视同放行。 */
export declare function firstToolBlock(hooks: LifecycleHook[], input: {
    sessionId: string;
    agent: string;
    tool: string;
    args: unknown;
...
export declare function fireAfterToolCall(hooks: LifecycleHook[], input: {
    sessionId: string;
    agent: string;
    tool: string;
    isError: boolean;
...
export declare function fireRunEnd(hooks: LifecycleHook[], input: {
    sessionId: string;
    agent: string;
    ok: boolean;
    aborted: boolean;
