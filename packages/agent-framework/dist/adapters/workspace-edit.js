...
function diffLines(prefix, value) {
    if (value === null || value === "")
        return [];
    return value.split("\n").map((line) => `${prefix}${line}`);
}
export function createUnifiedDiff(change) {
...
export function applySingleEdit(content, oldText, newText) {
    if (!oldText)
        return { error: "EDIT_TARGET_REQUIRED" };
...
//# sourceMappingURL=workspace-edit.js.map